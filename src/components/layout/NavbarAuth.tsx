...
import { BsCreditCard, BsPersonCircle } from "react-icons/bs";
...
const NavbarAuth = () => {
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-3 mr-5 fixed bg-[#181a20] z-40">
      ...
      <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-initial gap-x-4">
        <li>
          <a className="text-white text-sm hover:text-bnb-gold" href="overview">Overview</a>
        </li>
        <li>
