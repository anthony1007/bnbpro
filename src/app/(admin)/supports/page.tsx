...
// import { FaUserShield, FaReply, FaInbox, FaChevronDown, FaChevronUp } from "react-icons/fa";

// /**
//  * Admin Support Dashboard
//  * - Admin can see all tickets from users
//  * - Reply directly to any ticket
//  * - Dark luxury design
//  */
...
//             <span style={{ color: THEME.text }}>Administrator</span>
//           </div>
//         </div>
...
//                         className="px-4 py-2 rounded-md bg-[#FCD535] text-black flex items-center gap-2"
//                       >
//                         <FaReply /> Reply
//                       </button>
//                     </div>
...
//   async function changeStatus(ticketId: number, status: "OPEN" | "CLOSED") {
//     try {
//       const res = await fetch("/api/admin/support", {
//         method: "POST",
//         credentials: "include",
...
//             </h1>
//             <p className="text-sm text-[#A0A6B1] mt-1">
//               View and respond to all user support requests.
//             </p>
//           </div>
//           <FaUserShield className="text-[#FCD535] text-2xl" />
//         </div>
...
//                       <button
//                         onClick={() =>
//                           changeStatus(t.id, t.status === "OPEN" ? "CLOSED" : "OPEN")
//                         }
//                         className="px-4 py-2 rounded-md bg-[#1E2329] border border-[#2B3139] text-gray-300 hover:text-[#FCD535] flex items-center gap-2"
//                       >
//                         <FaCheckCircle /> {t.status === "OPEN" ? "Close" : "Reopen"}
//                       </button>
//                     </div>
//                   </motion.div>
//                 )}
