...
// import FundForm from "@/components/backend/Fund";
...
//             <div
//               key={fund.id}
//               className="p-4 rounded-2xl border shadow-lg hover:shadow-xl transition"
...
//           onSuccess={() => { setShowForm(false); fetchFunds(); }}
//         />
//       )}
//     </div>
//   );
